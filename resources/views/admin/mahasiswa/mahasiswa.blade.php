        ...
        <div class="card card-outline card-primary">
            <!-- <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="{{ route('mahasiswa.create') }}" class="btn btn-primary bg-info btn-tool" id="btn-create">Tambah
                        Mahasiswa</a>
                </div>
            </div> -->
            <section id="loading">
                    ...
                    <table id="dt" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="x-grid-cell-inner">{{ $value->nim ?? '-' }}</td>
                                ...
                                <td class="x-grid-cell-inner">
                                    <div class="row">
                                        <a href="{{ route('mahasiswa.edits', $value->id) }}" class="btn btn-sm btn-outline-warning mx-2" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                        <form method="post" onsubmit="return confirm('Hapus Data atas nama {{ $value->nama }}?');" action="{{ route('mahasiswa.delete', $value->id) }}">
                                            @csrf
                                            @method('delete')

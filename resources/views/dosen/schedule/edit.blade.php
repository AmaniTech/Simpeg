                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="pertemuan" name="pertemuan" class="form-control"
                            placeholder="PERTEMUAN" value="{{ $jadwal->pertemuan }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="kelas" name="kelas" class="form-control"
                            placeholder="Kelas" value="{{ $jadwal->kelas }}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input type="date" id="tanggal" name="tanggal" class="form-control"
                            placeholder="Tanggal" value="{{ $jadwal->tanggal }}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input type="time" id="jam" name="jam" class="form-control"
                            placeholder="Jam" value="{{ $jadwal->jam }}" required>
                    </div>
                </div>
                    ...
                    <div class="col-md-9">
                        <select class="form-control" name="matkul_id" id="matkul_id">
                            @foreach($matkul as $key)
                                <option {{ ($jadwal->matkul_id == $key->id) ? 'selected' : '' }} value="{{ $key->id }}">{{ $key->nama_matkul }}</option>
                            @endforeach
                        </select>
                    </div>
            </div>
                ...
                <div class="col-md-9">
                    <select class="form-control" name="dosen_id" id="dosen_id">
                        @foreach($dosen as $key)
                            <option {{ ($jadwal->dosen_id == $key->id) ? 'selected' : '' }} value="{{ $key->id }}">{{ $key->nama }}</option>
                        @endforeach
                    </select>
                </div>
            </div>

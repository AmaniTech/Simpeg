...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Management Jurusan</h3>
    </div>
    <div class="card-body">
    ...
    <div class="col-12">
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('jurusan.create') }}" class="btn btn-primary bg-info btn-tool" id="btn-create">Tambah
                        Jurusan</a>
                </div>
            </div>
            <section id="loading">
                    ...
                    <table id="dt" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="x-grid-cell-inner">{{ $value->nama_jurusan ?? '-' }}</td>
                                <td class="x-grid-cell-inner">{{ $value->kode_jurusan ?? '-' }}</td>
                                <td class="x-grid-cell-inner">
                                    <div class="row">
                                        <a href="{{ route('jurusan.edit', $value->id) }}" class="btn btn-sm btn-outline-warning mx-2" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                        <form method="post" onsubmit="return confirm('Hapus Data atas nama {{ $value->nama_jurusan }}?');" action="{{ route('jurusan.delete', $value->id) }}">
                                            @csrf
                                            @method('delete')

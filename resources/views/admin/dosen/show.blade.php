        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <a href="{{ route('dosen.createJabatan', ['id' => $dosen->id]) }}"
                        class="btn btn-primary bg-info btn-tool ml-auto">Tambah Riwayat Jabatan</a>
                </div>
                <div class="card-body">
                    @if ($dosen->rjabatans)
                                    ...
                                    @foreach ($dosen->rjabatans as $jabatan)
                                        <tr>
                                            ...
                                            <td class="x-grid-cell-inner">
                                                <div class="row">
                                                    <a href="{{ route('dosen.editJabatan', ['id' => $dosen->id, 'jabatanId' => $jabatan->id]) }}"
            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <a href="{{ route('dosen.createPenelitian', ['id' => $dosen->id]) }}"
                        class="btn btn-primary bg-info btn-tool" id="btn-create">Tambah Penelitian</a>
                </div>
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($dosen->rpenelitian as $penelitian)
                                        <tr>
                                            ...
                                            <td class="x-grid-cell-inner">
                                                <div class="row">
                                                    <a href="{{ route('dosen.editPenelitian', ['id' => $dosen->id, 'penelitianId' => $penelitian->id]) }}"
            ...
            <div class="card card-primary" id="edit-penelitian-form" style="display: none;">
                ...
                <div class="card-body">
                    <form id="penelitian-form"
                        action="{{ route('dosen.updatePenelitian', [$dosen->id, 'penelitianId']) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">

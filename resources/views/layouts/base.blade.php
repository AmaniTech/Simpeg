...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-2xl dropdown-menu-right">
          <span class="dropdown-item dropdown-header"><span class="notif-number">0</span> Notifications</span>
  ...
  <footer class="main-footer">
    <!-- To the right -->
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="">SIMPEG</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->

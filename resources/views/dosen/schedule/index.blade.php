    ...
    <div class="col-12">
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('schedule.create') }}" class="btn btn-primary bg-info btn-tool" id="btn-create">Tambah
                        Jadwal</a>
                </div>
            </div>
            <section id="loading">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="x-grid-cell-inner">
                                    <div class="row">
                                        <a href="{{ route('schedule.edit', $value->id) }}" class="btn btn-sm btn-outline-warning mx-2" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                        <form method="post" onsubmit="return confirm('Hapus Data atas nama {{ $value->dosen->nama }}?');" action="{{ route('schedule.delete', $value->id) }}">
                                            @csrf
                                            @method('delete')

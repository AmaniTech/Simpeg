...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Management Gaji</h3>
    </div>
    <div class="card-body">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('gaji.create') }}" class="btn btn-primary bg-info btn-tool" id="btn-create">Tambah
                        Gaji</a>
                </div>
            </div>
            <section id="loading">
                    ...
                    <table id="dt" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="x-grid-cell-inner">Rp. {{ number_format($value->honor_sks, 0, ',', '.') ?? '-' }}</td>
                                <td class="x-grid-cell-inner">
                                    <div class="row">
                                        <form method="post" onsubmit="return confirm('Hapus Data atas nama {{ $value->dosen->nama }}?');" action="{{ route('gaji.delete', $value->id) }}">
                                            @csrf
                                            @method('delete')

                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="x-grid-cell-inner">
                                    <div class="row">
                                        <a href="{{ route('users.edits', $value->id) }}" class="btn btn-sm btn-outline-warning mx-2" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                        <form method="post" onsubmit="return confirm('Hapus Data atas nama {{ $value->nama }}?');" action="{{ route('users.delete', $value->id) }}">
                                            @csrf
                                            @method('delete')

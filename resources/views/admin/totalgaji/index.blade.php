...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Management Gaji Dosen</h3>
    </div>
    <div class="card-body">
    ...
    <div class="col-12">
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    {{-- <a href="{{ route('dosen.create') }}" class="btn btn-primary bg-info btn-tool" id="btn-create">Tambah
                        Dosen</a> --}}
                </div>
            </div>
            <section id="loading">
                    ...
                    <table id="dt" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="x-grid-cell-inner">Rp. {{ $value->total_gaji ?? '-' }}</td>
                                {{-- <td class="x-grid-cell-inner">
                                    <div class="row">
                                        <a href="{{ route('show.hitung', $value->id) }}" class="btn btn-sm btn-outline-info" data-toggle="tooltip" title="Detail"><i class="fa fa-eye"></i></a>
                                        <a href="{{ route('edit.hitung', $value->id) }}" class="btn btn-sm btn-outline-warning mx-2" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
